                ...
                {dataFiltered && dataFiltered.paymentsAppointments.length > 0 ? (
                        ...
                        {dataFiltered.paymentsAppointments.map((payment) => (
                            ...
                            >
                                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                                    ...
                                    <span className="text-sm text-gray-600 dark:text-gray-300 truncate">
                                        <strong>Referencia:</strong> {payment.reference ? payment.reference.slice(0, 25) : 'N/A'}
                                    </span>
                    ...
                    >
                        ...
                        <p className="text-center text-gray-600 text-lg mb-3">
                            No hay pagos con Stripe registrados
                        </p>
                        <p className="text-sm text-center text-gray-500">cuando realicen un pago con Stripe, aparecerá aquí</p>
                    </motion.div>
                )}
            </motion.div>
        </div>
